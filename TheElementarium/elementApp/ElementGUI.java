...
import TheElementarium.Lanthanide;
import TheElementarium.Metalloid;
import TheElementarium.NobleGas;
import TheElementarium.PostTransitionMetal;
import TheElementarium.ReactiveNonmetal;
...
public class ElementGUI extends JFrame {
    public static final Color REGAL_NAVY = new Color(13, 59, 102);       // #0D3B66
    public static final Color LEMON_CHIFFON = new Color(250, 240, 202);  // #FAF0CA
    ...
    public ElementGUI() {
        ...
        MainMenuPanel menuPanel = new MainMenuPanel(
            ...
            e -> switchToFullScreen("Quiz")
        );

        QuizPanel quizPanel = new QuizPanel(
            e -> switchToMenuScreen()
        );
    ...
    private JPanel createPeriodicTableScreen() {
        ...
        tablePanel = new PeriodicTablePanel(this, e -> switchToMenuScreen());
