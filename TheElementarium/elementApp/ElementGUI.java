...
public class ElementGUI extends JFrame {
    ...
    public static Element createElement(String name, String symbol, int atomicNumber, double atomicWeight, String group, String electronConfig, String applications) {
        return switch (group) {
    ...
    public static Color getGroupColor(String group) {
        return Element.getGroupColor(group);
    }
