...
public class MainMenuPanel extends JPanel {
    ...
    public MainMenuPanel(ActionListener onSeeTableClicked, ActionListener onQuizClicked) {
        ...
        if (logoImage != null) {
            ...
            logoComponent.setForeground(ElementGUI.LEMON_CHIFFON); // Fallback text matches Lemon Chiffon
        }
        ...
        add(createButtonWrapper("Periodic Table Quiz", onQuizClicked), gbc);
        gbc.gridy = 5;
        gbc.weighty = 1.0;
